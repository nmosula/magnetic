...
lang : {
	...
	loadingTitle : 'Нажміть для виходу',
	...
	resizeTitle : 'Розтягнути',
	playText : 'Пуск',
	playTitle : 'Пуск слайдшоу (spacebar)',
	pauseText : 'Пауза',
	pauseTitle : 'Пауза (пробіл)',
	previousTitle : 'Попередня',
	nextTitle : 'Наступна',
	moveTitle : 'Перемістити',
	fullExpandText : 'Повний розмір',
	number: 'Image %1 of %2',
	restoreTitle : 'Нажміть, щоб закрити зображення, клацніть мишкою і починайте переміщати. Використовуйте кнопки зі стрілками, щоб переглядати зображення.'
},
