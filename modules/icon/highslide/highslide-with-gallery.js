...
lang : {
	...
	fullExpandText : 'Истинный размер',
	number: 'Image %1 of %2',
	restoreTitle : 'Кликните, чтобы закрыть изображение, щелкните мышью и начинайте перетаскивать, чтобы переместить. Используйте клавиши со стрелками чтобы просматривать изображения.'
},
