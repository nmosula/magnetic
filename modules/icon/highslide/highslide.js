...
lang : {
	...
	loadingTitle : 'Натисніть для виходу',
	focusTitle : 'Click to bring to front',
	fullExpandTitle : 'Показати у повному розмірі (f)',
	creditsText : 'www.proba.com.ua',
	creditsTitle : '',
	restoreTitle : 'Натисніть, щоб закрити або натисніть і утримуйте для переміщення.'
},
